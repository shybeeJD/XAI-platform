...
from ex_methods.module.adaptiveAvgPool2d import AdaptiveAvgPool2d, AvgPool2d
...
class _DenseLayer(Module):
    ...
    def _simple_lrp(self, R, labels, r_method="composite"):
        """
        <Chennel dim>
        input R : (L+1)*k 
        R_init : L*k
        ...
        for key, module in enumerate(reversed(self._modules.values())):
            R = module.lrp(R, labels, r_method)
